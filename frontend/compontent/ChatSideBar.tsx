...
import { CornerDownLeft, CornerDownRight, LogOut, MessageCircle, Plus, Search, UserCircle, X } from 'lucide-react';
...
function ChatSideBar({
  ...
  return (
    <aside>
      <div className={`fixed z-20 sm:static top-0 left-0 h-screen w-80 bg-gray-900 border-r border-gray-700 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} sm:translate-x-0 transition-transform duration-300 flex flex-col`}>
              ...
              {chats.map((chat) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-lg transition-colors border ${isSelected ? "bg-blue-600 border-blue-500" : "border-gray-700 hover:border-gray-600 hover:bg-gray-800"}`}
                  >
                    <div className='flex items-center gap-3'>
                      {/* avatar + online dot */}
                      <div className='relative'>
                      ...
                      <div className='flex-1 min-w-0'>
                        <div className='flex items-center justify-between mb-1'>
                          ...
                          {unseenCount > 0 && (
                            <div className='bg-red-600 text-white text-xs font-bold rounded-full min-w-5.5 h-5 flex items-center justify-center px-2'>
                        ...
                        {latestMessage && (
                          <div className='flex items-center gap-2'>
                            {isSentByMe
                              ? <CornerDownLeft size={14} className='text-blue-400 shrink-0' />
