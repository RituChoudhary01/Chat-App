import { Loader2, Paperclip, Send, X } from 'lucide-react'; // ✅ Fix 1: Loader2 and Send were used but never imported
...
function MessageInput({ selectedUser, message, setMessage, handleMessageSend }: MessageInputProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => { // ✅ Fix 3: was e:any
    e.preventDefault()
